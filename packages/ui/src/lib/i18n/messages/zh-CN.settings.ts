...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.notifications.page.backgroundAutoAccept.label': '后台自动接受',
  'settings.notifications.page.backgroundAutoAccept.aria': '后台自动接受',
  'settings.notifications.page.backgroundAutoAccept.failed': '更新后台自动接受设置失败',

...
export const dict = {
  ...
  'chat.revertPopover.keepShort': 'Keep',
  'chat.revertPopover.commit': 'Remove for good',
  'chat.revertPopover.choiceTitle': 'Reverted messages',
  'chat.revertPopover.clearDescription': 'Restore these messages to the conversation so they remain in context.',
  'chat.revertPopover.commitDescription': 'Permanently remove these messages from the conversation and its context.',

...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.appLinks.info": "Los enlaces de aplicaciones del chat (p. ej., chrome://) se abren en otra aplicación tras confirmarlo. Los protocolos de confianza se abren sin volver a preguntar.",

...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.appLinks.title": "Enlaces de aplicaciones",
  "settings.openchamber.appLinks.info": "Los enlaces de aplicaciones del chat (p. ej., obsidian://) se abren en otra aplicación tras confirmarlo. Los protocolos de confianza se abren sin volver a preguntar.",
  "settings.openchamber.appLinks.empty": "Aún no hay enlaces de aplicaciones de confianza. Elige \"Confiar y abrir\" al abrir un enlace para añadirlo aquí.",

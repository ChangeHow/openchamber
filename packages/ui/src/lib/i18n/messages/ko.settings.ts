...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.appLinks.title': '앱 링크',
  'settings.openchamber.appLinks.info': '채팅의 앱 링크(예: obsidian://)는 확인 후 다른 앱에서 열립니다. 신뢰한 프로토콜은 다시 묻지 않습니다.',
  'settings.openchamber.appLinks.empty': '아직 신뢰된 앱 링크가 없습니다. 링크를 열 때 "신뢰하고 열기"를 선택하면 여기에 추가됩니다.',

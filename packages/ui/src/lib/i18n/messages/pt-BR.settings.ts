...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.appLinks.info": "Os links de aplicativos do chat (ex.: chrome://) são abertos em outro aplicativo após confirmação. Protocolos confiáveis abrem sem perguntar novamente.",

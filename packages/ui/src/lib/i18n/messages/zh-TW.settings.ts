...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.appLinks.title': '應用程式連結',
  'settings.openchamber.appLinks.info': '聊天中的應用程式連結（如 obsidian://）經確認後會在其他應用程式中開啟。受信任的通訊協定不再詢問。',
  'settings.openchamber.appLinks.empty': '目前沒有受信任的應用程式連結。開啟連結時選擇「信任並開啟」即可加入這裡。',

export const settingsDict = {
  ...
  'settings.openchamber.appLinks.info': 'Application links from chat (such as chrome://) open in another application after confirmation. Trusted schemes open without asking again.',

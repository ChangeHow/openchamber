...
export const dict = {
  ...
  'chat.textSelection.actions.askOpenChamber': 'Demander à OpenChamber',
  'chat.textSelection.title.askOpenChamber': 'Demander à OpenChamber à propos de la sélection',
